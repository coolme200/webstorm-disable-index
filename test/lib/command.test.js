...
describe('test/lib/command.test.js', () => {
  ...
  it('should should support complex architecture with sub modules that each one has its own node_modules', function*() {
    ...
    yield command.run(path.join(__dirname, '../fixtures/complex-sub-modules'));
    command.expect('modules.xml', '<module filepath="$PROJECT_DIR$/.idea/complex-sub-modules.iml" fileurl="file://$PROJECT_DIR$/.idea/complex-sub-modules.iml"/>');
    command.expect('misc.xml', '<option name="languageLevel" value="ES6"/>');

    command.expect('jsLibraryMappings.xml', '<includedPredefinedLibrary name="ECMAScript 6"/>');
    command.expect('jsLibraryMappings.xml', '<includedPredefinedLibrary name="Node.js Core"/>');
    command.expect('jsLibraryMappings.xml', '<file url="PROJECT" libraries="{node-DefinitelyTyped,mocha-DefinitelyTyped}"/>');
    command.expect('jsLibraryMappings.xml', '<excludedPredefinedLibrary name="complex-sub-modules/node_modules"/>');

    command.expect('complex-sub-modules.iml', '<content url="file://$MODULE_DIR$/node_modules/egg"/>');
    command.expect('complex-sub-modules.iml', '<excludeFolder url="file://$MODULE_DIR$/node_modules"/>');
    command.expect('complex-sub-modules.iml', '<excludeFolder url="file://$MODULE_DIR$/node_modules/egg/node_modules"/>');
    command.expect('complex-sub-modules.iml', '<excludeFolder url="file://$MODULE_DIR$/node_modules"/>');

    command.expect('complex-sub-modules.iml', '<content url="file://$MODULE_DIR$/empty/node_modules/egg"/>');
    command.expect('complex-sub-modules.iml', '<excludeFolder url="file://$MODULE_DIR$/empty/node_modules"/>');
